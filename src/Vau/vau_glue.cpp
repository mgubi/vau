...
template<> tmscm
tmscm_from<tree> (tree o) {
  return blackbox_to_tmscm (close_box<tree> (o));
}

template<> tree
tmscm_to<tree> (tmscm obj) {
...
struct scheme_tree_wrap {
  tree t;
  inline scheme_tree_wrap (const tree& x) : t (x) {};
};

template<> tmscm
tmscm_from<scheme_tree_wrap> (scheme_tree_wrap tw) { return scheme_tree_to_tmscm (tw.t); }

template<> scheme_tree_wrap
tmscm_to<scheme_tree_wrap> (tmscm p) { return tmscm_to_scheme_tree (p); }
...
DECLARE_GLUE_NAME_TYPE(eval_system,"eval-system", string (string))
DECLARE_GLUE_NAME_TYPE(var_eval_system,"var-eval-system", string (string))
DECLARE_GLUE_NAME_TYPE(evaluate_system,"evaluate-system", array_string (array_string, array_int, array_string, array_int))
...
DECLARE_GLUE_NAME_TYPE(texmacs_time,"texmacs-time", time_t ())
DECLARE_GLUE_NAME_TYPE(pretty_time,"pretty-time", string (int))
DECLARE_GLUE_NAME_TYPE(mem_used,"texmacs-memory", int ())
DECLARE_GLUE_NAME_TYPE(bench_print,"bench-print", void (string))
DECLARE_GLUE_NAME_TYPE(bench_print,"bench-print-all", void ())
...
DECLARE_GLUE_NAME_TYPE(translate,"translate", string (content))
DECLARE_GLUE_NAME_TYPE(translate_as_is,"string-translate", string (string))
DECLARE_GLUE_NAME_TYPE(translate,"translate-from-to", string (content, string, string))
DECLARE_GLUE_NAME_TYPE(tree_translate,"tree-translate", tree (content))
DECLARE_GLUE_NAME_TYPE(tree_translate,"tree-translate-from-to", tree (content, string, string))
DECLARE_GLUE_NAME_TYPE(force_load_dictionary,"force-load-translations", void (string, string))
color named_color_wrap (string s) { return named_color(s); }
DECLARE_GLUE_NAME_TYPE(named_color_wrap,"color", color (string))
DECLARE_GLUE_NAME_TYPE(get_hex_color,"get-hex-color", string (string))
...
DECLARE_GLUE_NAME_TYPE(get_author,"get-author", double ())
...
DECLARE_GLUE_NAME_TYPE(clear_debug_messages,"clear-debug-messages", void ())
...
DECLARE_GLUE_NAME_TYPE(font_database_build_global,"font-database-build-global", void ())
DECLARE_GLUE_NAME_TYPE(font_database_build_characteristics,"font-database-build-characteristics", void (bool))
DECLARE_GLUE_NAME_TYPE(font_database_build_global,"font-database-insert-global", void (url))
...
DECLARE_GLUE_NAME_TYPE(font_database_search,"font-database-search", array_string (string, string))
...
DECLARE_GLUE_NAME_TYPE(guessed_features,"font-guessed-features", array_string (string, string))
DECLARE_GLUE_NAME_TYPE(guessed_distance,"font-guessed-distance", double (string, string, string, string))
DECLARE_GLUE_NAME_TYPE(guessed_distance,"font-master-guessed-distance", double (string, string))
DECLARE_GLUE_NAME_TYPE(guessed_features,"font-family-guessed-features", array_string (string, bool))
...
DECLARE_GLUE_NAME_TYPE(logical_font,"logical-font-public", array_string (string, string))
DECLARE_GLUE_NAME_TYPE(logical_font_exact,"logical-font-exact", array_string (string, string))
DECLARE_GLUE_NAME_TYPE(logical_font,"logical-font-private", array_string (string, string, string, string))
...
DECLARE_GLUE_NAME_TYPE(scheme_tree_to_tree,"stree->tree", tree (scheme_tree))
...
DECLARE_GLUE_NAME_TYPE(is_atomic,"tree-atomic?", bool (tree))
DECLARE_GLUE_NAME_TYPE(is_compound,"tree-compound?", bool (tree))
DECLARE_GLUE_NAME_TYPE(L,"tree-label", tree_label (tree))
DECLARE_GLUE_NAME_TYPE(A,"tree-children", array_tree (tree))
DECLARE_GLUE_NAME_TYPE(N,"tree-arity", int (tree))
...
DECLARE_GLUE_NAME_TYPE(is_extension,"tree-label-extension?", bool (tree_label))
...
DECLARE_GLUE_NAME_TYPE(minimal_arity,"tree-minimal-arity", int (tree))
DECLARE_GLUE_NAME_TYPE(maximal_arity,"tree-maximal-arity", int (tree))
DECLARE_GLUE_NAME_TYPE(correct_arity,"tree-possible-arity?", bool (tree, int))
...
DECLARE_GLUE_NAME_TYPE(get_env_child,"tree-child-env*", tree (content, int, content))
DECLARE_GLUE_NAME_TYPE(get_env_child,"tree-child-env", tree (content, int, string, content))
DECLARE_GLUE_NAME_TYPE(get_env_descendant,"tree-descendant-env*", tree (content, path, content))
DECLARE_GLUE_NAME_TYPE(get_env_descendant,"tree-descendant-env", tree (content, path, string, content))
...
DECLARE_GLUE_NAME_TYPE(is_empty,"tree-empty?", bool (content))
...
DECLARE_GLUE_NAME_TYPE(search,"tree-search-tree", array_path (content, content, path, int))
DECLARE_GLUE_NAME_TYPE(search,"tree-search-tree-at", array_path (content, content, path, path, int))
DECLARE_GLUE_NAME_TYPE(spell,"tree-spell", array_path (string, content, path, int))
DECLARE_GLUE_NAME_TYPE(spell,"tree-spell-at", array_path (string, content, path, path, int))
DECLARE_GLUE_NAME_TYPE(spell,"tree-spell-selection", array_path (string, content, path, path, path, int))
...
DECLARE_GLUE_NAME_TYPE(minimal_arity,"tag-minimal-arity", int (tree_label))
DECLARE_GLUE_NAME_TYPE(maximal_arity,"tag-maximal-arity", int (tree_label))
DECLARE_GLUE_NAME_TYPE(correct_arity,"tag-possible-arity?", bool (tree_label, int))
...
DECLARE_GLUE_NAME_TYPE(start,"path-start", path (content, path))
DECLARE_GLUE_NAME_TYPE(end,"path-end", path (content, path))
...
DECLARE_GLUE_NAME_TYPE(get_type,"modification-kind", string (modification))
...
DECLARE_GLUE_NAME_TYPE(index,"modification-index", int (modification))
DECLARE_GLUE_NAME_TYPE(argument,"modification-argument", int (modification))
DECLARE_GLUE_NAME_TYPE(L,"modification-label", tree_label (modification))
DECLARE_GLUE_NAME_TYPE(copy,"modification-copy", modification (modification))
DECLARE_GLUE_NAME_TYPE(is_applicable,"modification-applicable?", bool (content, modification))
DECLARE_GLUE_NAME_TYPE(var_clean_apply,"modification-apply", tree (content, modification))
DECLARE_GLUE_NAME_TYPE(var_apply,"modification-inplace-apply", tree (tree, modification))
DECLARE_GLUE_NAME_TYPE(invert,"modification-invert", modification (modification, content))
DECLARE_GLUE_NAME_TYPE(commute,"modification-commute?", bool (modification, modification))
DECLARE_GLUE_NAME_TYPE(can_pull,"modification-can-pull?", bool (modification, modification))
DECLARE_GLUE_NAME_TYPE(pull,"modification-pull", modification (modification, modification))
DECLARE_GLUE_NAME_TYPE(co_pull,"modification-co-pull", modification (modification, modification))
DECLARE_GLUE_NAME_TYPE(patch,"patch-pair", patch (modification, modification))
DECLARE_GLUE_NAME_TYPE(patch,"patch-compound", patch (array_patch))
DECLARE_GLUE_NAME_TYPE(branch_patch,"patch-branch", patch (array_patch))
DECLARE_GLUE_NAME_TYPE(patch,"patch-birth", patch (double, bool))
DECLARE_GLUE_NAME_TYPE(patch,"patch-author", patch (double, patch))
DECLARE_GLUE_NAME_TYPE(is_modification,"patch-pair?", bool (patch))
DECLARE_GLUE_NAME_TYPE(is_compound,"patch-compound?", bool (patch))
...
DECLARE_GLUE_NAME_TYPE(N,"patch-arity", int (patch))
DECLARE_GLUE_NAME_TYPE(access,"patch-ref", patch (patch, int))
...
DECLARE_GLUE_NAME_TYPE(get_author,"patch-get-author", double (patch))
DECLARE_GLUE_NAME_TYPE(copy,"patch-copy", patch (patch))
DECLARE_GLUE_NAME_TYPE(is_applicable,"patch-applicable?", bool (patch, content))
DECLARE_GLUE_NAME_TYPE(var_clean_apply,"patch-apply", tree (content, patch))
DECLARE_GLUE_NAME_TYPE(var_apply,"patch-inplace-apply", tree (tree, patch))
...
DECLARE_GLUE_NAME_TYPE(invert,"patch-invert", patch (patch, content))
DECLARE_GLUE_NAME_TYPE(commute,"patch-commute?", bool (patch, patch))
DECLARE_GLUE_NAME_TYPE(can_pull,"patch-can-pull?", bool (patch, patch))
DECLARE_GLUE_NAME_TYPE(pull,"patch-pull", patch (patch, patch))
DECLARE_GLUE_NAME_TYPE(co_pull,"patch-co-pull", patch (patch, patch))
...
DECLARE_GLUE_NAME_TYPE(is_double,"cpp-string-number?", bool (string))
...
DECLARE_GLUE_NAME_TYPE(search_forwards,"string-search-forwards", int (string, int, string))
DECLARE_GLUE_NAME_TYPE(search_backwards,"string-search-backwards", int (string, int, string))
DECLARE_GLUE_NAME_TYPE(overlapping,"string-overlapping", int (string, string))
DECLARE_GLUE_NAME_TYPE(replace,"string-replace", string (string, string, string))
DECLARE_GLUE_NAME_TYPE(find_non_alpha,"string-find-non-alpha", int (string, int, bool))
DECLARE_GLUE_NAME_TYPE(is_alpha,"string-alpha?", bool (string))
...
DECLARE_GLUE_NAME_TYPE(trim_spaces_left,"string-trim-spaces-left", string (string))
DECLARE_GLUE_NAME_TYPE(trim_spaces_right,"string-trim-spaces-right", string (string))
DECLARE_GLUE_NAME_TYPE(trim_spaces,"string-trim-spaces", string (string))
...
DECLARE_GLUE_NAME_TYPE(as_hexadecimal,"integer->hexadecimal", string (int))
DECLARE_GLUE_NAME_TYPE(as_hexadecimal,"integer->padded-hexadecimal", string (int, int))
...
DECLARE_GLUE_NAME_TYPE(spell_start,"multi-spell-start", void ())
DECLARE_GLUE_NAME_TYPE(spell_done,"multi-spell-done", void ())
DECLARE_GLUE_NAME_TYPE(spell_start,"single-spell-start", string (string))
DECLARE_GLUE_NAME_TYPE(spell_done,"single-spell-done", void (string))
...
DECLARE_GLUE_NAME_TYPE(spell_accept,"spell-accept", void (string, string))
...
DECLARE_GLUE_NAME_TYPE(parse_latex,"parse-latex", tree (string))
DECLARE_GLUE_NAME_TYPE(parse_latex_document,"parse-latex-document", tree (string))
...
DECLARE_GLUE_NAME_TYPE(compute_keys,"compute-keys-string", array_string (string, string))
DECLARE_GLUE_NAME_TYPE(compute_keys,"compute-keys-tree", array_string (content, string))
DECLARE_GLUE_NAME_TYPE(compute_keys,"compute-keys-url", array_string (url))
DECLARE_GLUE_NAME_TYPE(compute_index,"compute-index-string", scheme_tree (string, string))
DECLARE_GLUE_NAME_TYPE(compute_index,"compute-index-tree", scheme_tree (content, string))
DECLARE_GLUE_NAME_TYPE(compute_index,"compute-index-url", scheme_tree (url))
DECLARE_GLUE_NAME_TYPE(url,"url->url", url (url))
DECLARE_GLUE_NAME_TYPE(url_root,"root->url", url (string))
DECLARE_GLUE_NAME_TYPE(url,"string->url", url (string))
DECLARE_GLUE_NAME_TYPE(as_string,"url->string", string (url))
DECLARE_GLUE_NAME_TYPE(as_tree,"url->stree", scheme_tree (url))
DECLARE_GLUE_NAME_TYPE(url_system,"system->url", url (string))
DECLARE_GLUE_NAME_TYPE(as_system_string,"url->system", string (url))
DECLARE_GLUE_NAME_TYPE(url_unix,"unix->url", url (string))
DECLARE_GLUE_NAME_TYPE(as_unix_string,"url->unix", string (url))
DECLARE_GLUE_NAME_TYPE(url,"url-unix", url (string, string))
DECLARE_GLUE_NAME_TYPE(url_none,"url-none", url ())
DECLARE_GLUE_NAME_TYPE(url_wildcard,"url-any", url ())
DECLARE_GLUE_NAME_TYPE(url_wildcard,"url-wildcard", url (string))
DECLARE_GLUE_NAME_TYPE(url_pwd,"url-pwd", url ())
DECLARE_GLUE_NAME_TYPE(url_parent,"url-parent", url ())
...
DECLARE_GLUE_NAME_TYPE(is_rooted,"url-rooted?", bool (url))
DECLARE_GLUE_NAME_TYPE(is_rooted,"url-rooted-protocol?", bool (url, string))
DECLARE_GLUE_NAME_TYPE(is_rooted_web,"url-rooted-web?", bool (url))
DECLARE_GLUE_NAME_TYPE(is_rooted_tmfs,"url-rooted-tmfs?", bool (url))
DECLARE_GLUE_NAME_TYPE(is_rooted_tmfs,"url-rooted-tmfs-protocol?", bool (url, string))
DECLARE_GLUE_NAME_TYPE(get_root,"url-root", string (url))
DECLARE_GLUE_NAME_TYPE(unroot,"url-unroot", url (url))
DECLARE_GLUE_NAME_TYPE(is_atomic,"url-atomic?", bool (url))
DECLARE_GLUE_NAME_TYPE(is_concat,"url-concat?", bool (url))
DECLARE_GLUE_NAME_TYPE(is_or,"url-or?", bool (url))
DECLARE_GLUE_NAME_TYPE(url_ref,"url-ref", url (url, int))
DECLARE_GLUE_NAME_TYPE(head,"url-head", url (url))
DECLARE_GLUE_NAME_TYPE(tail,"url-tail", url (url))
DECLARE_GLUE_NAME_TYPE(file_format,"url-format", string (url))
DECLARE_GLUE_NAME_TYPE(suffix,"url-suffix", string (url))
DECLARE_GLUE_NAME_TYPE(basename,"url-basename", string (url))
DECLARE_GLUE_NAME_TYPE(glue,"url-glue", url (url, string))
...
DECLARE_GLUE_NAME_TYPE(last_modified,"url-last-modified", int (url))
DECLARE_GLUE_NAME_TYPE(url_temp,"url-temp", url ())
...
DECLARE_GLUE_NAME_TYPE(move,"system-move", void (url, url))
DECLARE_GLUE_NAME_TYPE(copy,"system-copy", void (url, url))
DECLARE_GLUE_NAME_TYPE(remove,"system-remove", void (url))
DECLARE_GLUE_NAME_TYPE(mkdir,"system-mkdir", void (url))
DECLARE_GLUE_NAME_TYPE(rmdir,"system-rmdir", void (url))
...
DECLARE_GLUE_NAME_TYPE(system,"system-1", void (string, url))
DECLARE_GLUE_NAME_TYPE(system,"system-2", void (string, url, url))
...
DECLARE_GLUE_NAME_TYPE(keep_history,"tmdb-keep-history", void (url, bool))
DECLARE_GLUE_NAME_TYPE(set_field,"tmdb-set-field", void (url, string, string, array_string, double))
DECLARE_GLUE_NAME_TYPE(get_field,"tmdb-get-field", array_string (url, string, string, double))
DECLARE_GLUE_NAME_TYPE(remove_field,"tmdb-remove-field", void (url, string, string, double))
...
DECLARE_GLUE_NAME_TYPE(connection_start,"connection-start", string (string, string))
DECLARE_GLUE_NAME_TYPE(connection_status,"connection-status", int (string, string))
DECLARE_GLUE_NAME_TYPE(connection_write,"connection-write-string", void (string, string, string))
DECLARE_GLUE_NAME_TYPE(connection_write,"connection-write", void (string, string, content))
DECLARE_GLUE_NAME_TYPE(connection_cmd,"connection-cmd", tree (string, string, string))
DECLARE_GLUE_NAME_TYPE(connection_eval,"connection-eval", tree (string, string, content))
